...
public class XlogFileDecoder {
    ...
    public static String PRIV_KEY = "42448f69c8b6f40fb41c9052e132a1e6d7858e0a7abcc5acfa621acfde933a30";
    public static String PUB_KEY = "4516e4e1fc48e5894f09d0b2d8511c0c784c93a36d3d5c30f5074dc46be5aeb9d5564eee76d09e8a20765baefe67f5f2f92ea501225529fd9f206deb4ee8d55a";

    public static byte[] BYTE_PRIV_KEY = CommonUtils.hexStringToBytes(PRIV_KEY);
    private static boolean isCrypt = false;
    ...
    public static void ParseFile(String _file, String _outfile, boolean crypt) {
        isCrypt = crypt;
